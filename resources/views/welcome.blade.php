...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:image" content="http://notes.williammaddicott.com/images/6b.jpg">
        <!-- Twitter Meta Tags -->
        ...
        <meta name="twitter:image" content="http://notes.williammaddicott.com/images/6b.jpg">
    </head>
    <body>
        <div id="root">
        </div>
